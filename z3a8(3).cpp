...
//----------- 1. A két objeltum, amit bekér a másol függvény, az az eredeti binárisfa gyökere és az eredeti binárisfa, fa mutatója. Mind a kettő Csomópont típusú objektumra mutat
...
//------------- 6. Ez a Csomópont osztály konstruktora. Alapértelmezetten a csomópont betű tagváltozója a / karakterrel egyenlő. 
//------------- és a két mutatója a balNulla  és a jobbEgy ami Csomópont típusú objektumra mutathatnak , most a Null-ra mutatnak.
...
//--------------5. Ez a fa mutató segít a binárisfa felépítésében tulajdonképpen az LZW binfaépítő algoritmusnak kell. Később a másoló konstruktornak.
     Csomopont *fa;
     // technikai
...
//-------------  2. A Csomópont típusu objektumra mutató ujelem kezdetben a Null értékű, nem mutat sehova se.  
          Csomopont * ujelem = NULL;
//-------------3. Ha a elem nem a Nullra mutat
          if ( elem != NULL ) {
//------------- 4. Akkor az újelem egyolyan csomópontra mutat aminek a char betű tagváltozója megegyezik az elem csomópont betűjével.
//------------- A new operátorral egy ilyen új csomópontnak foglalunk memóriát
// ------------A Csomopont(elem->getBetu()) pedig egy konstruktor. A konstruktorokkal értéket adhatunk az objektumunk tagváltozóinak. Ebben az esetben a Csomópont osztály által definiált csomópont 
//-------------objektum char betű tipusú tagváltozójának.
//-------------a másolásról sajnos nem tudok többet.
